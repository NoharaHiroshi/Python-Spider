...
base_url = r'http://tj.fangjia.com/ershoufang/'
...
def get_page(url):
    headers = {
        ...
        'Referer': r'http://tj.fangjia.com/ershoufang/',
        'Host': r'tj.fangjia.com',
...
if __name__ == '__main__':
    ...
    fin_info_list = get_info_list(test_search_dict, layer, tmp_list, search_list)
